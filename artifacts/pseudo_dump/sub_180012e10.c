  ...
  int64_t sub_180012e10(int64_t arg1, int64_t arg2, char arg3)

{
    ...
    if ((*(*rcx + 0x1a0))(rcx, arg1, &arg_20, &var_50))
        return 0;
    ...
    if (arg_20 > 0)
    {
        while (!i)
        {
            ...
            if ((*(*rcx_1 + 0x1d8))(rcx_1, arg1, *(r8_1 + (r14_1 << 3)), &var_40, &var_48, &var_38))
                i = 0;
            else
            {
                ...
                int64_t r8_3 = var_50;
                int32_t var_58 = 0;
                (*(*rcx_2 + 0x1e8))(rcx_2, arg1, *(r8_3 + (r14_1 << 3)), &var_58);
                char* rbx_1 = var_48;
                
                if (rbx_1 && !strcmp(rbx_1, arg2) && (var_58 >> 3 & 1) == arg3)
                {
                    i = *(var_50 + (r14_1 << 3));
                    sub_1800023a0("  findFieldByDesc(%s, static=%d): '%s'", arg2);
                    rbx_1 = var_48;
                }
