  ...
  int64_t sub_18001b900(char* arg1, char* arg2, int32_t* arg3)

{
    ...
    if (rbx && _GetImageBase() != -(rbx))
    {
        ...
        if (*(rax_4 + 0x10) && (!(*arg1 & 0x80) || !(*arg2 & 0x10)))
        {
            int64_t rsi = *(arg1 + 4);
            int64_t rbx_2;
            ...
            if ((rbx_2 == *(arg2 + 4) + rax_6 || !(rdx - i)) && (!(*arg2 & 2) || *arg1 & 8))
            {
                char rax_11 = *arg3;
                
                if ((!(rax_11 & 1) || *arg1 & 1) && (!(rax_11 & 4) || *arg1 & 4)
                        && (!(rax_11 & 2) || *arg1 & 2))
                    return 1;
            }
